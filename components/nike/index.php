...
<body>
    <header class="fluit">
        ...
        <div class="loguear">
            ...
            <div class="btn ini"><a href="login/login.php">Iniciar sesion</a></div>
            <div class="btn res"><a href="#">Reservar</a></div>
    ...
    <main class="mt-2">
        ...
        <div class="buscador container mt-1 mb-1">
            <form action="" id="buscador">
                ...
                <div class="btnHome"><a href="../../index.php"><i class="fa-solid fa-house-chimney"></i></a></div>
            </form>
        </div>
        ...
        <div class="container muestra">
            ...
            <div class="imgMuestras">
                <div class="pack">
                    <div class="img"><img width="150px" src="../../img/InShot_20250113_121830319.png" alt=""></div>
                </div>
            </div>
        </div>
